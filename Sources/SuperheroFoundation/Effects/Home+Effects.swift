...
extension Home {
    public static func effect(decoder: JSONDecoder) -> Effect<APIResponse, APIError> {
    ...
    public static func testEffect(decoder: JSONDecoder) -> Effect<APIResponse, APIError> {
